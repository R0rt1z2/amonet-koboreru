...
#define TEE_LOAD_ADDR 0xA8880000
#endif
#ifndef TEE_MEM_SIZE
#define TEE_MEM_SIZE  0x17780000
#endif
...
#define GPIO_MAX_PIN        135     /* pins 0..134 */
...
#define GPIO_IES_MAP_LEN    33
#define GPIO_SPEC_PUPD_LEN  2
...
#define gpio_pupd_is_msdc(pin) \
    (((pin) >= 22 && (pin) <= 27) || ((pin) >= 57 && (pin) <= 68) || \
     ((pin) >= 73 && (pin) <= 78) || ((pin) >= 100 && (pin) <= 105))

/* KEYPAD */
#define KPD_PIN_KPCOL0 122
...
#define USB_PRODUCT_NAME       "MT8173 Preloader"
