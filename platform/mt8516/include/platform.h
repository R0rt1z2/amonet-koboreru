...
#define KPD_BASE        0x10002000

/* DEVINFO */
#define DEVINFO_MAX_INDEX 0x64
...
#define GPIO_MODE_OFFSET    0x300
#define GPIO_PULLEN_OFFSET  0x500
#define GPIO_PULLSEL_OFFSET 0x600
#define GPIO_IES_OFFSET     0x900

#define GPIO_MAX_PIN        125     /* pins 0..124 */
...
#define GPIO_IES_MAP_LEN    46
#define GPIO_SPEC_PUPD_LEN  24

extern const struct gpio_ies_group gpio_ies_map[];
extern const struct gpio_pupd_group gpio_spec_pupd[];

#define gpio_pupd_is_msdc(pin)  (0)

/* KEYPAD */
#define KPD_PIN_KPCOL0 42
...
#define USB_PRODUCT_NAME       "MT8516 Preloader"
